    ...
    <div class="bg-white shadow rounded-lg">
      ...
      <div class="px-6 py-6 space-y-6">
        ...
        <template v-else>
          <div
            v-if="message"
            class="rounded-md bg-green-50 text-green-800 px-4 py-3 text-sm"
          >
            {{ message }}
          </div>
          <div
            v-if="error"
            class="rounded-md bg-red-50 text-red-800 px-4 py-3 text-sm"
          >
            {{ error }}
          </div>
          ...
          <div
            ...
            class="rounded-md bg-primary-50 text-primary-900 px-4 py-3 text-sm"
          >
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-2">
              Keys are encrypted with the server’s settings encryption secret.
              Only you can use your key for suggestions after login.
            </p>
          </div>
