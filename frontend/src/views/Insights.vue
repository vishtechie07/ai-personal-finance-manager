  ...
  <div class="space-y-6 pt-6">
    ...
    >
      <div class="min-w-0">
        ...
        <p class="text-slate-600 mt-2">
          Smart financial analysis and recommendations for
          {{ currentMonthDisplay }}
        </p>
      </div>
      <button
    ...
    <div class="glass-card p-6">
      <div class="flex items-center justify-between">
        <h3 class="text-lg font-semibold text-slate-900">
          Viewing Insights for {{ currentMonthDisplay }}
        </h3>
    ...
    >
      ...
      <div class="glass-card p-6">
        <div class="flex items-center mb-4">
          ...
          <h3 class="text-lg font-semibold text-slate-900 ml-3">
            Spending Patterns
          </h3>
        </div>
    ...
    <div class="glass-card p-6">
      ...
      <p class="text-slate-600 text-sm">
        Our smart system continuously analyzes your financial data for
        {{ currentMonthDisplay }} to provide personalized insights and
        recommendations.
      </p>
    </div>
  </div>
