<template>
  <div class="space-y-6 pt-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <button type="button" @click="showAddBudget = true" class="btn-primary shrink-0">
    ...
    <div class="glass-card p-6">
      <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-semibold text-slate-900">Budgets for {{ currentMonthDisplay }}</h3>
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="budget in filteredBudgets" :key="budget.id" class="bg-slate-50 rounded-xl border border-slate-200 p-6 shadow-sm">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-lg font-semibold text-slate-900">{{ budget.name }}</h3>
    ...
    <div v-if="showAddBudget" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
          <h3 class="text-lg font-medium text-slate-900 mb-4">Create New Budget</h3>
